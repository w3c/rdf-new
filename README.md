...
This is the repository for the **_What's New in RDF_** deliverable of the [RDF & SPARQL Working Group](https://www.w3.org/groups/wg/rdf-star).
The editors’ draft of the specification can also be [read directly](https://w3c.github.io/rdf-new/spec/).
